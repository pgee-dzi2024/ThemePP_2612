...
if (pickrContainerPrimary && themeContainerPrimary) {
    for (const [theme, config] of nanoThemes) {
        ...
        button.addEventListener('click', () => {
            ...
            if (pickrContainerPrimary) {
                ...
                console.error('pickrContainerPrimary is null.');
                return;
            }
    ...
    function toggleTheme() {
        ...
        if (html.getAttribute('data-theme-mode') === "dark") {
            ...
            html.setAttribute('data-menu-styles', 'dark');
            document.querySelector('#switcher-dark-theme').checked = false;
            checkOptions();
...
var myHeadernotification = document.getElementById('header-notification-scroll-1');
if (myHeadernotification) {
    new SimpleBar(myHeadernotification, { autoHide: true });
}
...
headerbtn1.forEach(button => {
    button.addEventListener('click', (e) => {
        ...
        document.getElementById("notifiation-data").innerText = `${document.querySelectorAll('.dropdown-item-close1').length} Unread`;
                document.getElementById("notifiation-data-1").innerText = `${document.querySelectorAll('.dropdown-item-close1').length} Unread`;
        document.getElementById("notification-icon-badge").innerText = `${document.querySelectorAll('.dropdown-item-close1').length}`;
         document.getElementById("notification-icon-badge-1").innerText = `${document.querySelectorAll('.dropdown-item-close1').length}`;
